...
int clone(void (*fn)(void *), void *arg, void *stack){
  ...
  //Create main thread if not exist
...
int trprp(struct report_traps *rps)
{
  // loadInternalReports();
...
int chp(struct child_processes *chpcs)
{
